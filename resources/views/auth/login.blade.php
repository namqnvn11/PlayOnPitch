...
<div class="login-container text-center">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Input -->
        <div class="mb-3">
            <input type="email" class="form-control" id="login-email" name="email" placeholder="Enter email" value="{{ old('email') }}">
        ...
        <!-- Register Link -->
        <p class="mt-4 text-muted">Don't have an account? <a href="{{ route('register') }}" class="text-primary">Sign up</a></p>
    </form>
</div>
